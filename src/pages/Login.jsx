    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-[440px] flex-shrink-0 flex flex-col items-center justify-center bg-white px-10 py-12 shadow-2xl relative z-10">
        <div className="w-full max-w-xs">
          ...
          <p className="text-sm text-gray-500 mb-7">Entre com sua conta para continuar</p>

          {error && (
            <div className="mb-5 p-3 bg-red-50 border border-red-100 rounded-xl text-sm">
              <p className="text-red-600 font-medium">{error}</p>
              <p className="text-red-400 text-xs mt-1">Verifique seus dados ou fale com o administrador.</p>
            </div>
          )}
            ...
            <div>
              ...
              <div className="flex items-center input-field p-0 overflow-hidden focus-within:ring-2 focus-within:ring-orange-500 focus-within:border-transparent">
                <input
                  ...
                  autoCapitalize="none"
                />
                <span className="px-3 py-2 text-sm text-gray-500 bg-gray-50 border-l border-gray-200 select-none whitespace-nowrap">
                  @saobras.com
                </span>
              </div>
            </div>
