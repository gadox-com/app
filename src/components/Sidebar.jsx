        ...
        <div className="border-b border-gray-100 min-h-[72px] flex flex-col justify-center">
          {isOpen ? (
            ...
            <div className="flex flex-col items-center justify-center py-3 gap-2">
              ...
              <img src={FAVICON_BASE64} alt="São Brás" className="w-7 h-7 object-contain" />
            </div>
          )}
        </div>
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-100 safe-area-pb">
        <div className="flex items-stretch">
          ...
          <button
            ...
            className="flex-1 flex flex-col items-center justify-center py-2 gap-0.5 text-gray-400 hover:text-red-400 transition-colors"
          >
