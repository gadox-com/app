                    ...
                    <div className="flex-1 overflow-y-auto space-y-0 pr-1">
                      ...
                      <div className="flex items-center gap-2.5 pb-3 mb-3 border-b border-gray-100">
                        <div className="w-8 h-8 rounded-lg bg-orange-50 flex items-center justify-center flex-shrink-0">
                          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#F97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>
                        </div>
                        <div className="group flex flex-col gap-0 flex-1">
                          <span className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Brinco</span>
                          <div className="flex items-center gap-1">
                            <span className="text-xl font-bold text-gray-900 font-mono leading-tight">{animal.brinco}</span>
                            <button onClick={() => {}} className="opacity-0 group-hover:opacity-100 p-0.5 text-gray-300 hover:text-orange-400 transition-all">
